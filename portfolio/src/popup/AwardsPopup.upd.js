...
class AwardsPopup extends React.Component{
    state = {
        section : "",
        prize : "",
        agency : "",
        ...
        return(
                <div>
                    ...
                    <div style = {{display : "flex", justifyContent : "center", marginTop : "10px"}}>
                        <IconButton style={{color : "black"}} onClick = {() => this.upLoadAwards(this.props.fetchAwards, this.props.close, this.props.id)} >
