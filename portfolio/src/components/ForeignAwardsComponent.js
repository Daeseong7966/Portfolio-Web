...
import ForeignAwardsPopupupd from '../popup/ForeignAwardsPopup.upd';
...
class ForeignAwardsComponent extends React.Component{
    removeByid(id, fetchAwards){
        // eslint-disable-next-line no-restricted-globals
        if(confirm("게시물을 삭제하시겠습니까?")){
            console.log(id);
            axios.delete(`${SERVER}/foreignawards/${id}`)
            .then((response) => {
        ...
        return(
            <AwardsBox>
                <div>
                    ...
                    }>{close => <ForeignAwardsPopupupd close = {close} fetchAwards = {this.props.fetchAwards} id = {data.id} />}</Popup>
...
export default ForeignAwardsComponent;